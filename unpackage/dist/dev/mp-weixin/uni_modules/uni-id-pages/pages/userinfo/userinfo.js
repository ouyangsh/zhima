...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    i: common_vendor.o($options.setNickname),
    j: common_vendor.p({
      mode: "input",
    ...
    k: common_vendor.sr("dialog", "0be2f605-5"),
    l: common_vendor.p({
      type: "dialog"
    }),
    m: common_vendor.sr("bind-mobile-by-sms", "0be2f605-7"),
    n: common_vendor.o($options.bindMobileSuccess),
    o: $data.showLoginManage
  }, $data.showLoginManage ? common_vendor.e({
    p: $options.userInfo._id
